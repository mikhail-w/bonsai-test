  ...
  return (
    ...
    >
      <Flex h={16} alignItems="center" justifyContent="space-between">
        ...
        {/* <HStack boxShadow={'outline'} spacing={8} alignItems="center"> */}
        <HStack boxShadow={'outline'} spacing={8}>
          <HStack boxShadow={'outline'} display={{ base: 'none', md: 'flex' }}>
  ...
  return (
    ...
    >
      <Flex h={16} alignItems="center" justifyContent="space-between">
        ...
        <HStack as="nav" spacing={4} display={{ base: 'none', md: 'flex' }} color="black">
          <RouterLink to="/cart">
            <Button variant="link" id="cartLogo" color="black" position="relative">
              <ShoppingCart />
              <Badge
                colorScheme="green"
                borderRadius="full"
          ...
          {userInfo ? (
            <Menu>
              <MenuButton as={Button} variant="link" cursor="pointer" color="black" fontFamily="lato">
                <Avatar size={'md'} src={`http://127.0.0.1:8000${userInfo.avatar}`} />
              </MenuButton>
              <MenuList fontFamily="lato">
                <RouterLink to="/profile">
                  <MenuItem>Profile</MenuItem>
